...
class NormalModelHome extends StatefulWidget {
  const NormalModelHome({Key? key}) : super(key: key);

  @override
  State<NormalModelHome> createState() => _NormalModelHomeState();
}

class _NormalModelHomeState extends State<NormalModelHome> {
  @override
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Text("home page for normal model",style: TextStyle(
            fontSize: 40,
